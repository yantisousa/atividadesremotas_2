          ...
          <div class="col-3">
            <div class="card" style="width: 13rem; ">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item"><button class="btn btn-info"  onclick="editar({{$atividade->id}})"> <a href="{{route('atividades.edit', $atividade->id)}}">Editar</a> </button></li>
                  <li class="list-group-item"><button class="btn btn-danger"><a href="{{route('atividades.destroy', $atividade->id)}}">Excluir</a> </button></li>
                </ul>
              </div>
          </div>
          @empty
