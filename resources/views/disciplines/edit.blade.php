    ...
    <div class="container conteiner-login">
        <div class="row coluna-login">
            <div class="col-md-4 offset-md-4 align-self-center "
                ...
                <form action="{{route('disciplines.update', $disciplines->id)}}" method="POST" class="form-login">
                    @csrf
                    <h4>Editar Dados da Disciplina</h4>
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                <input type="text" class="form-control" id="exampleFormControlInput1" name="name" value="{{$disciplines->name}}"
                                    placeholder="Novo nome da disciplina">
                            </div>
                                </div>
