...
<div id="alunos" class="container text-center full"style=" height: 500px; border-radius: 10px; box-shadow: 22px 36px 44px -8px rgba(0,0,0,0.1);">
    <div class="row align-items-center" >
      <div class="col" style="border-radius: 10px; height: 500px; background-color: #006494; ">
        <img src="{{ url('assets/img/logo.png') }}" class="img-fluid" alt="..." style="width: 300px; margin-top: 100px; position:relative; left: 10px">
      </div>
      <div class="col">
        ...
        <form action="{{ route('alunos.login') }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                <input required name="password" type="password" placeholder="Senha"  class="form-control" id="exampleInputPassword1">
              </div>
              <button type="submit" class="btn btn-primary" style="background-color: #f4e208; border: none; color: black; width: 300px"><b>Entrar</b> </button>
            </form>
          </form>
      </div>
    </div>
  ...
  <div id="professores" class="container text-center full"style=" height: 500px; border-radius: 10px; box-shadow: 22px 36px 44px -8px rgba(0,0,0,0.1); display: none;">
    <div class="row align-items-center" >
        <div class="col">
          <form action="{{ route('login.store') }}" method="POST">
              ...
              <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary" style="background-color: #f4e208; width: 300px; border: none; color: black;"><b>Entrar</b> </button>
              </form>
            </form>
        </div>
